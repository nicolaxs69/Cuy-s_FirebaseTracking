...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void updateMarkers() {
        GeoFire geoFire = new GeoFire(reference.child(MyService.GEO_FIRE));
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(Cuy.LATITUDE, Cuy.LONGITUDE), 0.5);
